  ...
  return (
    <ThemedContainer>
      <View className="w-full flex-1 justify-evenly gap-2">
        ...
        <View className="w-full flex-1 justify-evenly gap-4 bg-primary dark:bg-black">
            ...
            <View className="mx-4 gap-4">
                ...
                <Link href="/perfil/dadospessoais/editar-perfil">
                  <CardContent className="py-safe-or-3.5 flex-row items-center">
                    <View className="mb-2 items-center">
                      <Text className="mb-2 font-semibold">Admissional</Text>
              ...
              <Card>
                <Link href="/perfil/dadospessoais/editar-perfil">
                  <CardContent className="py-safe-or-3.5 flex-row items-center">
                    <View className="mb-2 items-center">
                      <Text className="mb-2 font-semibold">Demissional</Text>
                      <View className="w-full flex-row justify-between">
                        <Stethoscope
                          size={40}
                          color={isDarkColorScheme ? "white" : "black"}
