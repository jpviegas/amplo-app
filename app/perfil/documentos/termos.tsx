...
import { Download, Eye, Files, Pencil, Share2 } from "lucide-react-native";
        ...
        <View className="w-full flex-1 justify-evenly bg-primary dark:bg-black">
          <View className="h-4/5">
            <View className="mx-4 gap-4">
              <Text className="text-center text-3xl font-bold">Termos</Text>
              <Card>
                <Link href="/perfil/dadospessoais/editar-perfil">
                  <CardContent className="py-safe-or-3.5 flex-row items-center">
                    <View className="mb-2 items-center">
                      <Text className="mb-2 font-bold">Confidencialidade</Text>
              ...
              <Card>
                <Link href="/perfil/dadospessoais/editar-perfil">
                  <CardContent className="py-safe-or-3.5 flex-row items-center">
                    <View className="mb-2 items-center">
                      <Text className="mb-2 font-bold">Resp Uso de E.P.I.</Text>
                      <View className="w-full flex-row justify-between">
                        <View>
                          <Files
                            size={40}
