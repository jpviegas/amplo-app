  ...
  "group flex items-center justify-center rounded-full web:ring-offset-background web:transition-colors web:focus-visible:outline-none web:focus-visible:ring-2 web:focus-visible:ring-ring web:focus-visible:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-primary border-2 bg-background web:hover:bg-accent web:hover:text-accent-foreground active:bg-accent",
      ...
      size: {
        ...
        icon: "h-10 w-10",
        full: "h-10 px-4 py-2 native:h-12 native:px-5 native:py-3 w-full",
      },
    },
    defaultVariants: {
      variant: "default",
